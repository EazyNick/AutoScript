// node-excel-compare.js
(function () {
    if (!window.NodeManager) {
        return;
    }

    window.NodeManager.registerNodeType('excel-compare', {
        /**
         * 노드 내용 생성
        ...
        renderContent(nodeData) {
            ...
            const icon = NodeIcons.getIcon('excel-compare', nodeData) || NodeIcons.icons?.default || '📊';
            ...
            return `
                ...
                <div class="node-content">
                    ...
                    <div class="node-text-area">
                        <div class="node-title">${this.escapeHtml(nodeData.title || '엑셀 비교')}</div>
