@echo off
REM Node installation batch file
REM Usage: install-node.bat [ZIP_FILE] [-f FOLDER] [--no-skip-duplicate]
...
"%PYTHON_CMD%" "%SCRIPT_DIR%package\install-node.py" %*
...
echo [SUCCESS] Node installation completed
echo.
pause
endlocal
